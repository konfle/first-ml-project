...
# 1. DATA COLLECTION
data = pd.read_csv("part_one/rent_apartments.csv")
print(data)
...
grid = GridSearchCV(rf, param_grid=grid_space, cv=2, scoring="r2")
...
pk.dump(rf, open('part_one/models/rf_v1', 'wb'))
rf_v1 = pk.load(open('part_one/models/rf_v1', 'rb'))
...
pk.dump(model_grid, open('part_one/models/rf_v2', 'wb'))
rf_v2 = pk.load(open('part_one/models/rf_v2', 'rb'))
